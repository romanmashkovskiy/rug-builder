RugBuilder.prototype.start = function() {
	...
	function continueLoading() {
		...
		new THREE.TextureLoader().load(
			templateDirectoryUri + '/rugbuilder/img/biscayne-bs105-bmap.jpg',
			function( texture ) {
		...
		new THREE.TextureLoader().load(
			templateDirectoryUri + '/rugbuilder/img/cotton-herringbone-bmap.jpg',
			function( texture ) {
		...
		function loaded() {
			...
			new THREE.TextureLoader().load(
				...
				templateDirectoryUri + '/rugbuilder/img/biscayne-bs105.jpg',
				function( texture ) {
		...
		*/
			...
			new THREE.TextureLoader().load(
				...
				templateDirectoryUri + '/rugbuilder/img/cotton-herringbone.jpg',
				function( texture ) {
			...
			function loadOtherJSON() {
				...
				for ( var i3 = 0; i3 < singleLowFiles.length; i3++ ) {
					...
					var url  = templateDirectoryUri + '/rugbuilder/json/single-low/' + singleLowFiles[i3] + '.json';
				...
				for ( var i4 = 0; i4 < doubleFiles.length; i4++ ) {
					...
					var url  = templateDirectoryUri + '/rugbuilder/json/double/' + doubleFiles[i4] + '.json';
				...
				for ( var i5 = 0; i5 < doubleLowFiles.length; i5++ ) {
					...
					var url  = templateDirectoryUri + '/rugbuilder/json/double-low/' + doubleLowFiles[i5] + '.json';
