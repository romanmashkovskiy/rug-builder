function load(options, secret_DEPRECIATED) {
	...
	if (window.location.hostname === 'localhost') {
		...
		document.write('<link rel="stylesheet" href="http://localhost:8888/crucial-trading/wp-content/themes/crucial-trading/rugbuilder-hospitality/assets/css/dist/hospitality-builder.min.css">');
	}
