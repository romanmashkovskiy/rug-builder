...
function retailer_loop($dist, $post_id, $title='', $iterator = '', $online = '', $view = '') {
  ...
  if  (array_key_exists('postcode', $_GET)) {
    $km = 0; //calc_distance($retailer_postcode, $retailer);
  }
  ...
  <a data-toggle="collapse" data-parent="#accordion" href="#$post_id" class="open-acc retailer-result-dropdown_menu r_accordion">
    <div class="retailer-result-dropdown_menu__left">
      <div id=title_$iterator class="retailer-result-dropdown_menu__left__title r_title">
        $title
      </div>
  ...
  <div id="$post_id" class="retailer-result-dropdown__dropdown panel-collapse collapse retailer_$iterator">
